...
osThreadId_t ledTaskHandle;  // LED线程
const osThreadAttr_t ledTask_attributes = {
    .name = "ledTask",
    .stack_size = 128 * 4,
    .priority = (osPriority_t)osPriorityNormal,
};
osThreadId_t jointTaskHandle;  // 按键线程
...
void StartDefaultTask(void *argument) {
  ...
  dataDisposeTaskHandle =
      osThreadNew(dataDisposeTask, NULL, &dataDisposeTask_attributes);
  jointTaskHandle = osThreadNew(jointTask, NULL, &jointTask_attributes);
