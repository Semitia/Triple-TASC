 ...
 * @file TIM4_ENC.c
 * @author Alexavier
 * @brief use TIM4 to capture encoder signal
 * @version 0.1
 * @date 2024-07-25
 *
...
void EncodeTime4Init(void) {
    ...
    TIM_ConfigEncoderInterface(TIM4, TIM_ENCODE_MODE_TI12, TIM_IC_POLARITY_RISING, TIM_IC_POLARITY_RISING);
    ...
    // TIM_ConfigInt(TIM4, TIM_INT_UPDATE, ENABLE); // 重装载中断
}
